# -*- coding: utf-8 -*-
"""
Created on Sat Oct 10 17:23:46 2020
...
def compare_excel_5_1M(infile1, infile2, outfile, sheet=None, r51data=None):
            ...
            for col in cols:
                for row in rows:
                    ...
                    if str1 == "nan" and str2 == "nan":
                        ...
                        diff_sheet.write(row + 1, col, "{} => None".format(a))
                        continue
...
#            diff_sheet = writer.sheets[name1]
            diff_sheet.set_row(1, 20, bold_format)
